      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-[520px] bg-white dark:bg-background-dark rounded-xl shadow-2xl p-8 overflow-hidden"
          >
            {/* Close Button */}
            <button 
              onClick={onClose}
            ...
            <div className="flex flex-col items-center text-center gap-6">
              <div className="flex flex-col gap-2">
                <h3 className="text-primary dark:text-slate-100 text-3xl font-bold leading-tight font-display tracking-tight">
              ...
              <div className="w-full">
                ...
                <textarea
                  ...
                  className="w-full min-h-[160px] p-5 rounded-lg border border-primary/10 bg-background-light dark:bg-background-dark focus:ring-2 focus:ring-primary focus:border-transparent outline-none text-primary dark:text-slate-200 placeholder:text-primary/30 transition-all resize-none font-display"
              ...
              <div className="w-full flex flex-col gap-4">
                <button
                  ...
                  disabled={loading}
                  className="w-full bg-primary hover:bg-primary/90 text-white font-bold py-4 px-6 rounded-lg transition-all transform active:scale-[0.98] shadow-lg shadow-primary/20 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                >
                  {loading ? (
