    ...
    <div className="h-full flex flex-col">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="flex justify-between items-center">
            <h2 className="text-3xl font-bold text-primary tracking-tight">Edit Product</h2>
            <div className="flex gap-3">
              <button 
        ...
        <div className="space-y-8">
          ...
          <div className="bg-background-light p-8 rounded-xl shadow-sm border border-border-subtle">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="md:col-span-2">
                <label className="block text-sm font-semibold text-primary/70 mb-2">Product Title</label>
                <input 
                  name="title"
                  value={formData.title}
                  onChange={handleInputChange}
                  className="w-full px-4 py-3 rounded-lg border border-border-subtle bg-background-soft focus:outline-none focus:border-primary transition-all text-primary placeholder:text-primary/40" 
                  placeholder="e.g. Italian Wool Blazer" 
                  type="text"
                />
              </div>
              <div className="md:col-span-2">
                <label className="block text-sm font-semibold text-primary/70 mb-2">Description</label>
                <textarea 
                  name="description"
              ...
              <div>
                <label className="block text-sm font-semibold text-primary/70 mb-2">Category</label>
                <select 
                  name="categoryId"
              ...
              <div>
                <label className="block text-sm font-semibold text-primary/70 mb-2">Gender</label>
                <div className="flex gap-6 h-[50px] items-center">
                  {['MALE', 'FEMALE', 'UNISEX', 'KIDS'].map((g) => (
                    <label key={g} className="flex items-center gap-2 cursor-pointer group">
                      ...
                      />
                      <span className={`text-sm font-medium transition-colors ${formData.gender === g ? 'text-primary' : 'text-primary/60 group-hover:text-primary/80'}`}>
          ...
          <div className="bg-background-light p-8 rounded-xl shadow-sm border border-border-subtle">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <label className="block text-sm font-semibold text-primary/70 mb-2">Original Price (₼)</label>
                <input 
                  name="originalPrice"
              ...
              <div>
                <label className="block text-sm font-semibold text-primary/70 mb-2">Discount Price (₼)</label>
                <input 
                  name="discountPrice"
                  ...
                  className="w-full px-4 py-3 rounded-lg border border-border-subtle bg-background-soft focus:outline-none focus:border-primary transition-all disabled:bg-primary/5 disabled:text-primary/40 disabled:cursor-not-allowed text-primary placeholder:text-primary/40" 
                  placeholder="0.00" 
                  type="number"
                />
              </div>
              <div>
                <label className="block text-sm font-semibold text-primary/70 mb-2">Discount Rate (%)</label>
                <input 
                  name="discountRate"
              ...
              <div key={cIdx} className="bg-background-light rounded-xl shadow-sm border-l-4 border-primary overflow-hidden border border-border-subtle relative">
                ...
                <div className="p-8">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    <div>
                      <label className="block text-sm font-semibold text-primary/70 mb-2">Select Color</label>
                      <select 
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-primary/70 mb-2">Color Name</label>
                      <input 
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-primary/70 mb-2">Color Code (Hex)</label>
                      <div className="flex gap-2">
                        ...
                        <input 
                          ...
                          disabled={colorSelectionTypes[cIdx] !== 'custom'}
                          className="flex-1 px-4 py-3 rounded-lg border border-border-subtle bg-background-soft focus:outline-none focus:border-primary uppercase transition-all disabled:bg-primary/5 disabled:text-primary/40 disabled:cursor-not-allowed text-primary" 
                          type="text"
                        />
                      </div>
                    </div>
                            ...
                            <div key={iIdx} className="flex items-center gap-4 bg-transparent py-2 group/img">
                              ...
                              <div className="flex items-center gap-4 shrink-0">
                                <label className="flex items-center gap-2 cursor-pointer shrink-0 group/main">
                                  ...
                                  />
                                  <span className={`text-xs font-bold transition-colors ${img.isMain ? 'text-primary' : 'text-primary/60 group-hover/main:text-primary/90'}`}>
                                    Main
                                  </span>
                                </label>
                                {iIdx > 0 && (
