      ...
      <main className="flex items-center justify-center min-h-screen px-6 py-24">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-12 flex justify-start">
            <Link to="/profile" className="group flex items-center gap-2 text-[#49352c]/60 dark:text-stone-400 hover:text-[#49352c] dark:hover:text-stone-100 transition-colors duration-300">
              <span className="material-symbols-outlined text-sm">arrow_back_ios</span>
              <span className="font-label text-[10px] tracking-[0.3em] uppercase font-bold">Back to Profile</span>
            </Link>
          </div>
