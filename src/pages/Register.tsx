              ...
              <form autoComplete="off" onSubmit={handleSubmit} className="flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <button className="flex items-center justify-center gap-3 h-14 w-full rounded-lg border border-primary/20 bg-white dark:bg-slate-800/50 hover:bg-background-light dark:hover:bg-slate-700 transition-all group cursor-pointer" type="button">
                    ...
                    <button className="flex items-center justify-center gap-3 h-14 w-full rounded-lg border border-primary/20 bg-white dark:bg-slate-800/50 hover:bg-background-light dark:hover:bg-slate-700 transition-all group cursor-pointer" type="button">
                      <svg className="size-5 fill-primary dark:fill-white" viewBox="0 0 24 24" fill="currentColor">
                      ...
                      <span className="text-primary text-sm font-bold uppercase tracking-wider">Continue with Apple</span>
                    </button>
                  </div>
                  {/* Separator */}
