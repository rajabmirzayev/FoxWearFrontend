  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col bg-background-light dark:bg-background-dark">
        <Header />
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-8 flex-1 w-full">
          {/* Breadcrumbs Skeleton */}
          <div className="flex gap-2 mb-8 animate-pulse">
            <div className="h-3 w-12 bg-primary/5 rounded"></div>
            <div className="h-3 w-4 bg-primary/5 rounded"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-7">
              <div className="flex flex-col-reverse md:flex-row gap-4 animate-pulse">
                <div className="md:w-20 flex md:flex-col gap-4">
                  {[1, 2, 3, 4].map(i => (
                    <div key={i} className="aspect-square w-20 bg-primary/5 rounded"></div>
                  ))}
                </div>
                <div className="flex-1 aspect-[4/5] bg-primary/5 rounded-lg"></div>
              </div>
            </div>
              ...
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    {[1, 2, 3].map(i => (
                      <div key={i} className="size-8 rounded-full bg-primary/5"></div>
                    ))}
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-4 gap-2">
                    {[1, 2, 3, 4].map(i => (
                      <div key={i} className="h-10 bg-primary/5 rounded"></div>
                    ))}
                  </div>
                </div>

                <div className="flex gap-3 pt-4">
                  <div className="flex-1 h-12 bg-primary/10 rounded-lg"></div>
                  <div className="w-12 h-12 bg-primary/5 rounded-lg"></div>
                </div>
                ...
                <div className="pt-6 border-t border-primary/10 space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="h-3 w-full bg-primary/5 rounded"></div>
                    <div className="h-3 w-2/3 bg-primary/5 rounded"></div>
                  </div>
                </div>
              </div>
            </div>
